...
- **🧠 Core Skills:** Object-Oriented Programming (OOP), Data Structures & Algorithms (DSA), System Design, and UML/Database modeling.
- **🌱 Goal:** To become a full-stack + AI engineer and build impactful, scalable products.

---

### Featured Projects & Experience
- **PetLink (Current FYP):** Cross-platform pet marketplace and shelter service engineered with integrated AI capabilities.
- **ATELIER:** A luxury e-commerce storefront deployed on Google Cloud Run (Next.js, PostgreSQL, Docker).
- **AI Service Orchestrator & Location Intelligence:** Agentic frameworks built for demographic analysis, foot traffic insights, and multi-agent reasoning.
- **ATS Free Resume Builder:** Automated resume parsing and formatting.
- **Car Rental Platforms:** Full-stack booking and inventory management.
- **Education Guidance Platform:** Interactive student resource system.

---

### Connect With Me
[![Portfolio](https://img.shields.io/badge/Portfolio-%23000000.svg?style=for-the-badge&logo=firefox&logoColor=#FF7139)](https://portfolio-eight-sigma-32zlaib6ci.vercel.app/)
...
```bash
# The spark is initialized
14-10-2022 : git branch one-sided-love

# The professional fall / catching feelings completely
13-02-2023 : git commit -m "Fell deeply"

# Pull request created but never merged...
08-07-2026 : git request-pull mutual-feelings
# Status: PENDING FOREVER 💔

# The branch still exists, waiting
